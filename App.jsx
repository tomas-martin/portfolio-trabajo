...
const projects = [
  {
    ...
    lang: "JavaScript",
    langColor: "#39ff14",
    demo: "https://portfoliotrabajos.vercel.app",
    github: "https://github.com/tomas-martin/portfolio-trabajo",
    desc: "Portfolio profesional. Exhibe proyectos y habilidades técnicas mediante un diseño vanguardista y animaciones fluidas.",
  ...
  },
  {
    ...
    desc: "Plataforma e-commerce oficial del club ATSC Futsal. Incluye catálogo interactivo, carrito de compras y gestión completa de pedidos.",
  ...
  },
  {
    ...
    desc: "Plataforma institucional para el club Futsal Rivadavia. Facilita la gestión administrativa y el pago de cuotas para afiliados.",
  ...
  },
  {
    ...
    desc: "Portfolio deportivo personalizado. Diseñado para destacar los logros, estadísticas y la trayectoria profesional del atleta.",
    tags: ["HTML", "CSS", "JavaScript"],
    category: "portfolio",
  },
  {
    ...
    desc: "Portfolio deportivo personal. Destaca por su diseño impactante, animaciones dinámicas y una experiencia de usuario inmersiva.",
    tags: ["HTML", "CSS", "JavaScript"],
    category: "portfolio",
  },
  {
    ...
    desc: "Landing page profesional para taller mecánico. Optimiza la presencia digital con detalle de servicios, contacto y sistema de reservas.",
    tags: ["HTML", "CSS", "JavaScript"],
    category: "cliente",
  },
  {
    ...
    desc: "Aplicación web integral para la gestión deportiva. Ofrece un panel de administración avanzado y métricas detalladas.",
  ...
  },
  {
    ...
    desc: "Sistema automatizado de reservas para complejos deportivos. Desarrollado con una arquitectura robusta en PHP y base de datos relacional.",
    tags: ["PHP", "MySQL", "HTML"],
    category: "app",
  },
  {
    ...
    desc: "Solución de comercio electrónico para artículos deportivos. Cuenta con catálogo dinámico, carrito de compras y flujo de checkout optimizado.",
    tags: ["HTML", "CSS", "JavaScript"],
    category: "cliente",
  },
  {
    ...
    desc: "Aplicación móvil multiplataforma construida con Flutter y Dart. Garantiza una experiencia nativa y fluida tanto en Android como en iOS.",
    tags: ["Flutter", "Dart"],
    category: "mobile",
  },
  {
    ...
    desc: "Plataforma web para la gestión inmobiliaria. Permite la publicación de propiedades y búsquedas eficientes mediante filtros avanzados.",
  ...
  },
  {
    ...
    desc: "Chatbot turístico desarrollado en Python. Brinda asistencia automatizada resolviendo consultas sobre destinos y actividades de interés.",
    tags: ["Python", "Bot"],
    category: "app",
  },
  {
    ...
    desc: "Solución web para el almacenamiento y gestión de archivos en la nube. Destaca por su interfaz moderna, intuitiva y accesible.",
    tags: ["HTML", "CSS", "JavaScript"],
    category: "app",
  },
  {
    ...
    desc: "Sistema corporativo para la gestión de aerolíneas en Java. Administra eficientemente reservas, bases de pasajeros y planificación de rutas.",
    tags: ["Java", "OOP"],
    category: "app",
  },
  {
    ...
    desc: "Repositorio de manifiestos de Kubernetes. Implementa prácticas DevOps para el despliegue escalable y automatizado de aplicaciones contenerizadas.",
